...
public class ApplicationController {
    ...
    private static final String HELLO_URL = "http://localhost:8080/ebx-dataservices/rest/data/v1/BBrancheSourceApplications/InstanceSourceApplications/root/T_APPLICATION";
